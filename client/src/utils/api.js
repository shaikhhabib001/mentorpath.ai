...
// Use a relative '/api' base during development so Vite proxy can forward requests to the backend.
// In production, set VITE_API_URL to the full backend URL (including /api) if needed.
